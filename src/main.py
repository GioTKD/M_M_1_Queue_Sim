...
class Simulation:
    ...
    def inc_time(self):
        ...
        self.total_wait += self.numb_system*(time_event-self.clock) # update total wait by consider total number customers in a system * the time that passed (which is t_event - clock)
